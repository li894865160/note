...
//    private AbstractMessageSource messageSource;
    ...
    public boolean preHandle(HttpServletRequest request,
		...
		if(uri.contains("/statics/") || uri.contains("/static/") || uri.contains("logout") 
				|| uri.contains("/download") || uri.contains("/page/") || uri.contains("/thirdpart/")
				|| uri.contains("/login")){
			return true;
		}
	...
	private boolean _reponseAuthenticationError(HttpServletResponse response) {
        ...
        try {
            ResponseEntity re = new ResponseEntity(errorCode, httpResponseMessage,0l,null,null);
